# testSAMstrt/testSAMstrt.py - a self annotated version of rgToolFactory.py generated by running rgToolFactory.py
# to make a new Galaxy tool called testSAMstrt
# User mika.yoshimura@riken.jp at 04/02/2015 19:57:37
# rgToolFactory.py
...
def main():
    ...
    a('--input_npms',default="None")
    a('--input_grp',default="None")
